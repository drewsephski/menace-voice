...
type Row = {
  /** The Menace Voice disposition being translated. Fixed for a built-in row. */
  source: string;
...
type Props = {
  ...
  /** Overrides currently stored, keyed by Menace Voice disposition. */
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Each Menace Voice disposition is sent as your own code wherever a call
        ...
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-[1fr_1fr_auto] items-center gap-x-3 gap-y-1 px-1 text-xs font-medium text-muted-foreground">
              <span>Menace Voice disposition</span>
              <span>Your code</span>
              <span className="w-8" />
            </div>
                ...
                return (
                  ...
                  >
                    {row.builtIn ? (
                      ...
                      <Input
                        aria-label="Menace Voice disposition"
                        value={row.source}
                        disabled={isSaving}
                        onChange={(event) =>
                    ...
                    {row.builtIn ? (
                      <Button
                        ...
                        title="Reset to the Menace Voice disposition"
                      >
