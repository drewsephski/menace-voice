...
// Not part of the generated Menace Voice SDK — a different host. All endpoints are PUBLIC
...
const BASE_URL = process.env.NEXT_PUBLIC_ONBOARDING_API_URL || "https://voice.menaceui.com";
