...
Menace Voice platform supports OpenAI, Google AI Studio, Google Vertex AI, Azure OpenAI, AWS Bedrock, Groq, OpenRouter, Hugging Face, MiniMax, Sarvam, and Menace Voice-managed LLMs. There are some models provided by default for you to choose from the drop down.
...
For locally deployed or self-hosted LLMs, Menace Voice also supports OpenAI-compatible endpoints such as Ollama and vLLM.
