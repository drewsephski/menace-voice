...
Menace Voice platform supports Deepgram, OpenAI, Google, Azure Speech, AssemblyAI, Speechmatics, Cartesia, Gladia, Sarvam, Smallest AI, Hugging Face, ElevenLabs, and Menace Voice transcribers. You can take a look at the providers documentation of which language to select for your language requirements.
...
For locally deployed or self-hosted STT models, Menace Voice also supports Speaches, an OpenAI API-compatible server for streaming transcription.
