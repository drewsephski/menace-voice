...
description: "Configure workflow-specific business outcomes and use them consistently across Menace Voice"
---
...
<Note>
  ...
  you enable it, Menace Voice keeps the disposition recorded by the event that ended
  the call.
</Note>
...
The code is the value Menace Voice stores for the run. Keep it stable and
...
At the end of an eligible call, Menace Voice analyzes the complete conversation and
...
speech, or classification fails, Menace Voice keeps the disposition already recorded
...
Menace Voice stores the termination mechanism, raw business outcome, and optional
...
4. Map each raw Menace Voice or workflow disposition to your preferred organization
   code.
