...
1. Clones the selected repo into `dograh/`. The script retains the upstream default `dograh-hq/dograh@main`; select `drewsephski/menace-voice` and the reviewed Menace release branch when prompted to build Menace Voice.
