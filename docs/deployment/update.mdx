---
title: "Update"
description: "Update your self-hosted Menace Voice stack to a newer image version"
---

This guide covers updating a Menace Voice stack you've already deployed with [Docker](/deployment/docker) or a [custom domain](/deployment/custom-domain). You run commands from the same directory that contains your `docker-compose.yaml` (this is the `dograh/` directory if you used `setup_remote.sh`).
...
|-------|-----------|---------|-------------|
| Release tag | `dograh-vX.Y.Z` | `dograh-v1.28.0` | Use when selecting a published release |
