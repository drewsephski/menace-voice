---
title: "Introduction"
description: "Build and operate Menace Agents programmatically from Python or TypeScript"
---
...
Generate an API key at [`/api-keys`](https://voice.menaceui.com/api-keys) (or `http://localhost:3010/api-keys` for self-hosted). See [API Keys](/configurations/api-keys) for details.
...
client = DograhClient(
    base_url="https://voice.menaceui.com",
