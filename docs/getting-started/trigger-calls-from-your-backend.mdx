...
If your team is manually dialing leads one by one, or your CRM needs to kick off a call the moment a lead comes in, this is how you automate that with Menace Voice.
...
```bash
curl -X POST https://voice.menaceui.com/api/v1/public/agent/test/{uuid} \
