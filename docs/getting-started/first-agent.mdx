...
This is the fastest path to a working voice agent. You'll create an agent, get a generated conversation flow, and talk to it in your browser — no phone number or telephony provider required.

<Note>
If your organization has no model configuration yet, wait for managed setup to finish when your deployment supports it, or open [Model Configurations](/configurations/inference-providers) to add a Service Key or your own provider keys before testing voice. Automatic provisioning is not guaranteed.
</Note>

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://www.youtube.com/embed/sGcOFhH8gxI"
  title="How to Build Your First Voice Agent in Menace Voice"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
></iframe>

<Note>
Using the hosted platform, go to [voice.menaceui.com](https://voice.menaceui.com). Self-hosting locally? Use `http://localhost:3010` instead, and follow [Getting Started](/getting-started) first to get the platform running.
</Note>

## Step 1: Create an agent

Go to [voice.menaceui.com/workflow](https://voice.menaceui.com/workflow) and create a new agent.
...
You don't need to understand the full [graph model](/voice-agent/introduction#the-graph-model) yet — the generated agent can run once model inference is configured. You can come back and customize prompts once you've heard it talk.
