---
title: "Prerequisites"
description: "System requirements and setup needed to run Menace Voice locally"
---
...
To run Menace Voice locally, make sure you have the following installed:
...
Use the container registry configured for your Menace deployment package when pulling the API and UI images.
