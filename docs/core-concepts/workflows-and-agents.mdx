...
description: "How conversation flows are defined in Menace Voice"
---
...
Every time you update a workflow's `workflow_definition`, Menace Voice saves a new version while keeping the history. The current version is always what runs. Old versions are retained for auditing.
