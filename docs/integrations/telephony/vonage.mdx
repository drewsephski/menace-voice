...
Vonage (formerly Nexmo) is a cloud communications platform that provides global voice, messaging, and video capabilities. Menace Voice's Vonage integration enables high-quality voice interactions with your agents using Vonage's robust infrastructure.
...
2. Copy your **Signature Secret** from the same Vonage account. Menace Voice uses it
...
### Step 3: Configure in Menace Voice
