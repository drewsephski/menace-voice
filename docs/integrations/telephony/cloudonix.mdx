...
3. (Optional) Navigate to your domain's **Applications** and create (or open) the application you'll use with Menace Voice, then copy its **Application Name**. Skip this if you want Menace Voice to auto-create the Voice Application for you on save.

### Step 2: Configure in Menace Voice
...
4. Enter your credentials:
   - Bearer Token
   - Domain ID
   - Application Name — *optional*. Leave blank and Menace Voice will auto-create a Voice Application on save (with the application `url` and CXML runtime already configured) and store its name on this configuration.
