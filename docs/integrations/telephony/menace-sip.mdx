...
Every Menace Voice organization is provisioned with a telephony configuration named
**Menace Voice Cloudonix SIP**. It gives you a SIP domain that is already connected
to the Menace Voice pipeline — you do not need a Cloudonix account, and there
