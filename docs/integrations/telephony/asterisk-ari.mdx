...
description: "Connect Menace Voice to your Asterisk PBX using the Asterisk REST Interface (ARI)"
---
...
Click **Save Configuration**. Menace Voice assigns a **Stasis App Name** to this configuration — something like `dograh_a1b2c3d4e5f6` — and shows it on the configuration page. Copy it; you need it for [Part 3](#part-3-route-calls-into-the-stasis-application).
