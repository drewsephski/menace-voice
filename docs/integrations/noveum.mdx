...
description: "Connect Menace Voice to Noveum — full-call tracing, audio capture, and AI-powered evaluation for your voice agents"
---
...
The export is **post-call and bring-your-own-key**: while the call is live, Menace Voice only records data locally — nothing is sent to Noveum and no latency is added to the conversation. After the call finishes, the trace and audio are uploaded in the background using the Noveum API key you configure on the node.
...
In your Menace Voice workflow editor, click **Add node** and scroll to the **Integrations** section. Select **Noveum**.

<img
  src="/images/tuner-dograh-workflow-builder.png"
  alt="Menace Voice workflow builder — click Add node"
/>
...
<img
  ...
  alt="Menace Voice Integrations panel showing the Noveum node"
/>
...
<img
  ...
  alt="Menace Voice Edit Noveum modal with API key, project, environment, and audio fields"
/>
...
<img
  ...
  alt="Noveum trace view showing a Menace Voice call with per-turn STT, LLM, and TTS spans"
/>
...
- [Noveum documentation](https://noveum.ai/docs) — Complete platform docs, including the [Menace Voice integration guide](https://noveum.ai/docs/integration-examples/dograh/overview)
