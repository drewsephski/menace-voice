...
<p align="center">
  <img src="docs/images/hero.gif" alt="Menace Voice 实战演示 —— 搭建工作流、启动语音智能体、直接对话" width="80%">
</p>
...
<div align="center">
  <a href="https://youtu.be/9gPneyf9M9w">
    <img src="docs/images/video_thumbnail_1.png" alt="观看 Menace Voice 演示视频" width="70%" style="border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
  </a>
</div>
...
Menace Voice 内置 MCP 服务器,因此编码智能体可以直接在你的 Menace Voice 工作区中操作。

连接 Codex、Claude Code、Cursor 或任何 MCP 客户端后,可以查看现有智能体、搜索 Menace Voice 文档、获取节点 schema、创建新工作流,并通过自然语言保存草稿修改。
...
Menace Voice 基于 [BSD 2-Clause 协议](LICENSE)提供。
